...
def convert_hdf5_data_to_ome_tiff(filename, output_directory, angle_map, objective_choice, overwrite):
    ...
    tiff_filename = tiff_filename.replace('_left_Cam_left', '_obj_left_Cam_left_tp')
    if objective_choice == 1:
        tiff_filename = tiff_filename.replace('_right_Cam_right', '_obj_right_Cam_right_tp')
    elif objective_choice == 2:
        tiff_filename = tiff_filename.replace('_right_Cam_long', '_obj_right_Cam_long_tp')
                ...
                if is_unsigned_integer(dataset):
                    ...
                    if objective_choice == 1:
                        ...
                        if 'left' in filename:
                            ...
                            uint16_data_z_flipped =  np.flip(uint16_data,axis= 2)  # use a different flip axis
...
if __name__ == "__main__":
    ...
    directory_path = '/mnt/data/to_deconvolve/haibei/2025-08-03_145249_tinman346_48YGAL4_UASmChCAAX_HiRFP'
