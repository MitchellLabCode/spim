...
minval_mip = newArray(180, 100, 100); // Example min LUT values for 3 channels
maxval_mip = newArray(900, 900, 600); // Example max LUT values for 3 channels
minval_midZ = newArray(180, 100, 100); // Example min LUT values for 3 channels
maxval_midZ = newArray(700, 700, 500); // Example max LUT values for 3 channels
