...
def save_as_ome_tiff(hdf5_filename, dataset_name, uint16_data_z_flipped, output_directory, angle_map, overwrite):
    ...
    tiff_filename = tiff_filename.replace('_left_Cam_left', '_left_flipped')
    tiff_filename = tiff_filename.replace('_right_Cam_right', '_right_unflipped')
    ...
    imwrite(tiff_path, uint16_data_z_flipped, metadata={'axes':'ZYX'},description=ome_metadata.to_xml())
...
if __name__ == "__main__":
    ...
    directory_path = '/mnt/data/midgut_tubulogenesis/48Y-GAL4-klar_UASmChCAAXSLamGFP/2024-05-06_143154'
