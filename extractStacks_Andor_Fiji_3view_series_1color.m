    ...
    for time = TInit:TEnd
        ...
        for k = 1 : filesize     
            ...
            if counter > 2*meta(1).stacksize
                ...
                name1 = fullfile(datafolder,['Time_',sprintf('%06d',TimeCount),'_Angle_',num2str(angle+0*180),'_c',num2str(col),'_ls_',num2str(ls),'.ome.tif']);
                name2 = fullfile(datafolder,['Time_',sprintf('%06d',TimeCount),'_Angle_',num2str(angle+1*180),'_c',num2str(col),'_ls_',num2str(ls),'.ome.tif']);
...
if counter ~=1 && ismember(TimeCount, timestamps_to_save)
    ...
    name1 = fullfile(datafolder,['Time_',sprintf('%06d',TimeCount),'_Angle_',num2str((p-1)*angle_increment+0*180),'_c',num2str(col),'_ls_',num2str(ls),'.ome.tif']);
    name2 = fullfile(datafolder,['Time_',sprintf('%06d',TimeCount),'_Angle_',num2str((p-1)*angle_increment+1*180),'_c',num2str(col),'_ls_',num2str(ls),'.ome.tif']);
