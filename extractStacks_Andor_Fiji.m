    ...
    for time = TInit:TEnd
        ...
        for k = 1 : filesize%/2;      
            ...
            if counter > 2*meta(1).stacksize
               ...
               name1 = ['data/Time_',sprintf('%06d',TimeCount),'_Angle_',num2str((p-1)*90),'_c',num2str(col),'.ome.tif'];
               name2 = ['data/Time_',sprintf('%06d',TimeCount),'_Angle_',num2str((p-1)*90+180),'_c',num2str(col),'.ome.tif'];
